<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Amatic+SC:wght@700&display=swap" rel="stylesheet">
<style>
	h3 {
		font-family: 'Cinzel', cursive;
      text-align: center;
      color: #d35400; /* Deep orange color */
      font-size: 3rem;
      margin-top: 20px;
      letter-spacing: 2px;
...
<h2 style="text-align: center;" class="orange-text">Login!</h2>
	<form method="POST">
